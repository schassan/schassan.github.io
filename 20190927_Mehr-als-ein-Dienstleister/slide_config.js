var SLIDE_CONFIG = {
  // Slide settings
  settings: {
    title: '"Mehr als ein Dienstleister"', //<br>
    subtitle: 'Die Rolle der Digital Humanities und Infrastruktur<br/>für den Erfolg einer digitalen Edition',
    eventInfo: {
      title: 'Workshop "Digitales Edieren in der Klassischen Philologie"',
      date: '27.9.2019'
    },
